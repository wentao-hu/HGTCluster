...
class NodeDataLoader:
  def __init__(self, graph, mask=gl.Mask.TRAIN, sampler='random',
               ...
               src_node_type = None, pos_relation_dict=None, 
    ...
    self._q, self._relation_path, self._node_type_path, self._relation_count, self._alias_list = self._query(self._graph, self._src_node_type)
    
    print('=for node cluster: relation_path',self._relation_path)
    print('=for node cluster: node_type_path',self._node_type_path)
    print('=for node cluster: relation_count',self._relation_count)  
    print('=for node cluster: alias_list',self._alias_list)
