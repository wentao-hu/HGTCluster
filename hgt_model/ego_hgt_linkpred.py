...
class EgoHGT(tfg.Module):
    def __init__(self,
        ...
        # print('==node_type_list', self.node_type_list)
        ...
        for node_type in self.node_type_list:
            ...
            # self.pre_linears[key] = tfg.LinearLayer("pre_linear_"+key, input_dim, hidden_dim, use_bias=True)
            self.pre_linears.append(tfg.LinearLayer("pre_linear_" + node_type, input_dim, hidden_dim, use_bias=True))

        # TODO: output_dim != hidden_dim
